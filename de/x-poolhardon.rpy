...
label poolhardon1:
    ...
    b "Saya bertanya -tanya apa yang mereka lakukan"
    a "Mari kita juga menelepon ibuku"
    s "[bname] Kami siap"
    scene phardon1 with dissolve
    b "..."
    scene phardon2 with dissolve
    b "Hehe"
    scene phardon3 with dissolve
    b "{i} (sialan mengapa itu sangat sulit dan besar tiba -tiba) {/i}"
    b "Saya tidak tahu apa yang terjadi"
    b "Bagaimanapun, itu normal bagi saya"
    scene phardon4 with fade
    b "Argh"
    scene phardon5 with dissolve
    menu:
        "Pulang":
            pass
        "Cobalah untuk menyelesaikannya di toilet":
            s "Kemana kamu pergi?"
            b "Toilet"
            b "Aku akan kembali"
            jump romom1
    ...
    s "Kemana kamu pergi?"
    b "Rumah"
    s "Mungkin terlalu berat baginya"
    s "Apakah dia akan baik -baik saja?"
    a "Ya jangan khawatir tentang dia"
    s "Aku tidak bisa membiarkannya pergi sendiri, aku harus mengikutinya"
