...
{i} seberapa cepat hal -hal dapat berubah selamanya. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
{i} Suatu hari Anda bangun dan hari berikutnya Anda turun. {/i}"
    scene expression ("gambar/episode1/002.webp") with dissolve
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
{i} Saya tidak percaya bahwa perusahaan saya [dad] bangkrut dan sekarang kami harus pindah. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
...
{i} Kami baru saja kehilangan rumah kami, yang memiliki kolam renang, sauna, 10 kamar, bioskop dalam ruangan, 8 kamar mandi dan ... sial, sangat sulit untuk mengucapkan selamat tinggal pada semua ini. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
{i} Saya masih berharap ini hanya mimpi yang buruk dan di pagi hari ketika saya bangun, saya masih akan memiliki mobil sport saya di depan, yang saya dapatkan untuk ulang tahun ke -18 saya. {/i}"
    scene expression ("gambar/episode1/003.webp") with dissolve
    toby ""When you reached the top of the mountain you should take a break and look down for a bit.\"{/i}"
...
{i} mengatakan pria yang tersedot oleh bayi pirang yang cantik. Saya masih manja. {/i}"
        toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
{i} setidaknya sampai dia mengetahui bahwa perusahaan saya [dad] bangkrut dan itulah alasan sebenarnya mengapa kita pergi. {/i}"
...
{i} Saya harus mandi. {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
{i} Saya harus memberi tahu Emma alasan sebenarnya mengapa kita pergi. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
{i} Tapi bagaimana jika dia benar -benar menyukai [sister] saya mengatakan? {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
{i} Bagaimana jika dia benar -benar bersamaku hanya untuk uang. Maksudku, aku bukan pria terbaik. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size}
...
Ini dia. Setelah menghabiskan seluruh hidup saya di satu kota, saya akhirnya pindah ke kota yang berbeda. {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya tidak bisa mengatakan bahwa saya ingin tinggal di sana selamanya, tetapi saya selalu membayangkan diri saya pindah sendiri pada usia ini, tidak seperti ini. {/i}"
    scene expression ("gambar/episode1/035.webp") with dissolve
    play sound "audio/fx/notification_5.mp3"
    "*Notification Sound*"
    scene expression ("gambar/episode1/034.webp") with dissolve
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya sudah 20 tahun. Hidupku tidak menuju ke mana -mana. Saya selalu berencana untuk mendapatkan perusahaan [father] saya suatu hari, tetapi setelah apa yang terjadi, sekarang saya tidak tahu apa yang harus dilakukan dengan hidup saya. {/i}"
    scene expression ("gambar/episode1/035.webp") with dissolve
    play sound "audio/fx/notification_5.mp3"
    "*Notification Sound*"
    scene expression ("gambar/episode1/034.webp") with dissolve
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Kami bangkrut. Kami kehilangan segalanya dan sekarang kami pindah ke kota di mana mitra [father] saya berada. Seorang temannya akan membiarkan kami tinggal di sana, tetapi siapa yang tahu berapa lama. {/i}"
    scene expression ("gambar/episode1/035.webp") with dissolve
    play sound "audio/fx/notification_5.mp3"
    "*Notification Sound*"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Itu Patricia, atau Tris seperti orang memanggilnya. Dia adalah yang lebih muda [sister]. Selalu bertingkah seolah dia pantas mendapatkan segalanya. Sama seperti sekarang. 
Saya berbicara, dan dia bahkan tidak repot -repot menjawab saya. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Kami dulu rukun, tetapi selama beberapa bulan terakhir seperti dia menjadi gila. Saya tidak tahu apa yang terjadi padanya, tetapi saya bahkan tidak bisa melakukan percakapan normal dengannya. {/i}"
    scene expression ("gambar/episode1/036.webp") with dissolve
...
Saya nyaman."
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Itu [dad] saya. Pria yang kehilangan segalanya. Dia mengatakan bahwa kita adalah orang dewasa muda, tetapi dia tidak pernah memberi tahu kami bagaimana dia berhasil kehilangan segalanya. {/i}"
    toby ""Kids, we're bankrupt and we have to move!\". Tidak ada penjelasan, tidak ada apa -apa. Dia tidak menghormati kita dan tidak pernah memilikinya, tetapi sekarang dia mengharapkan kita untuk berperilaku seperti orang dewasa muda! {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Dan itu [mom] saya. Dia satu -satunya orang normal dalam hal ini [family]. Dia dulunya adalah gadis desa yang sederhana, tapi kemudian dia menikah [dad], dan dia agak memberinya semua yang dia inginkan. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Jadi dia mungkin sedikit manja, tetapi meskipun demikian dia mengambil seluruh kebangkrutan dengan cukup baik. Saya kira fakta bahwa dia tidak selalu kaya membuatnya sedikit lebih kuat, tidak seperti [dad] dan [sis], mungkin bahkan diri saya sendiri. {/i}"
    ...
    charlotte "Anda tidak hanya mengatakan itu tentang [kids] kami. Saya membesarkannya dengan baik. Andalah yang mengacaukan dan ingin menemukan seseorang untuk disalahkan!"
...
Sekarang saya merasa tidak enak karena menyebabkan situasi ini. Saya seharusnya hanya meninggalkan Tris sendirian. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Aku benci ketika keduanya berdebat. Rasanya seperti selamanya sejak kita bahagia. Saya tidak percaya bagaimana pecah dapat merusak A [family]. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya hanya berharap mereka tidak akan bercerai. Aku benci itu, tapi tahu [dad] dia akan melakukan segala yang dia bisa untuk tidak kalah [mom] dan mendapatkan kembali perusahaannya. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Dia selalu seperti itu dan dia terus -menerus mencoba membuat saya menjadi seperti dia. Terima kasih padanya, saya juga tidak quitter. {/i}"
...
Untung kami senang. {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Punggung saya sakit sudah hanya memikirkan berapa banyak kotak yang harus kita bawa ke dalam. {/i}"
    ...
    toby "Lihat [dad]. Saya mengerti Anda kesal karena kehilangan segalanya, tetapi berhenti mengeluarkan masalah Anda, terutama pada [mom]."
...
Itulah yang saya pikirkan. Dia tidak pernah suka mendengarkan siapa pun! {/i}"
    ...
    erwin "Anda masih favorit saya [daughter]."
    scene expression ("gambar/episode1/060.webp") with dissolve
    toby "*batuk*
Hanya [daughter]!"
    scene expression ("gambar/episode1/059.webp") with dissolve
    erwin "Terserah, Anda berdua [children] saya, dan Anda pantas mendapatkan yang terbaik. Itulah alasan saya bekerja sangat keras."
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya harus memberi tahu Emma bahwa kami telah menetap dan melihat apa yang dia lakukan. {/i}"
...
Jika wanita itu menginginkan, wanita itu menginginkannya. Anda tidak dapat berdebat dengan itu. {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Ini sangat bagus. Sangat menyenangkan untuk melepaskan beberapa stres setelah hari seperti itu. {/i}"
...
Umm. Di mana saya harus meletakkan selimut saya? Kamar ini sangat kecil. {/i}"
    ...
    hide screen ui_message
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Sobat, saya tidur seperti log. Saya ingin tahu jam berapa sekarang. {/i}"
...
Sayang sekali saya punya pacar. {/i}"
            ...
            toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Sialan [toby!c]. Dia [sister] Anda, bodoh. Anda tidak dapat melihat [sister] Anda seperti itu. {/i}"
...
Meskipun dia panas sekali. {/i}"
        "{i} menjadi baik [brother] {/i}":
            scene expression ("gambar/episode1/101.webp") with dissolve
            toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Tidak. Tidak hari ini. Hari ini saya baik [brother]. {/i}"
...
Hari Baru, Kota Baru. Saya merasa harus membantu [dad] dengan uang, tetapi saya tidak yakin apa yang bisa saya lakukan untuk mendapatkannya. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya selalu bisa pergi berburu pekerjaan, tetapi satu -satunya pekerjaan yang pernah saya miliki adalah di perusahaan [dad] saya dan jujur saja, saya agak manja. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Tidak ada yang benar -benar mengharapkan saya untuk melakukan apa pun, jadi itu benar -benar masih seperti saya tidak pernah bekerja sehari dalam seluruh hidup saya. {/i}"
...
Bagaimanapun, saya kelaparan. Mari kita lihat apa yang kita miliki di lemari es, jika ada. {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Belahan belah [mom!c] sangat besar! {/i}"
    menu:
        "{i} [JGR] Lihat lebih baik {/i}"(csq="Charlotte +1 & Galeri Gambar"):
            $ charlotte_rel += 1
            $ unlockImage(persistent.charlotte_02)
            scene expression ("gambar/episode1/115.webp") with dissolve
            toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya tidak percaya betapa baiknya dia mencari wanita seusianya. {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
[mom!c] benar. Saya harus berbicara dengan Emma tentang apa yang sebenarnya terjadi. Mungkin saat dia datang mengunjungi saya, saya akan mengatakan yang sebenarnya. {/i}"
    scene expression ("gambar/episode1/124.webp") with long_dissolve
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Mari kita lihat ada apa dengan pekerjaan ini? {/i}"
...
Wanita ini gila. {/i}"
    menu:
        ...
        "[JGR] Saya dapat memuaskan wanita mana pun, jadi mengapa Anda berbeda?"(csq="Katrina +1 & Gambar Galeri"):
            $ katrina_rel += 1
...
Oke ... itu sangat mencurigakan. {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Wawancara itu benar -benar sesuatu. Itu bukan yang saya harapkan, tetapi baik Darlene dan Katrina adalah wanita yang sangat menarik. {/i}"
    ...
    toby "Saya akan memberi tahu Anda nanti setelah kami mengambil [mom]. Saya benar -benar tidak ingin menceritakan kisah yang sama dua kali."
...
Seperti [mother], seperti [daughter]. {/i}"
    ...
    charlotte ""
    scene expression ("") with dissolve
    patricia "Saya tidak setuju dengan [mom]. Saya pikir bekerja di klub bisa lebih menarik dan di atas itu, siapa tahu. Mungkin Anda akan bertemu dengan pacar baru."
...
Mana yang harus saya berikan [mom]? {/i}"
    ...
    $ progress = 15
    menu:
        "{i} [JGR] Biarkan dia menang {/i}"(csq="Tris +1 & Galeri Gambar & Penting untuk Jalur Tris '"):
            $ patricia_rel += 1
...
Sial cara dia menatapku membuatku sangat terangsang dan sekarang aku punya kesalahan! {/i}"
    ...
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Dia memperhatikan. Sial, bercinta, persetan dengan hidupku. {/i}"
    if patricia_rel == 3:
        ...
        patricia "Ewww. Ada apa denganmu? Saya [sister] Anda!"
...
Pastikan Anda tidak ketinggalan tempat! {/i}"
...
Anak baik. {/i}"
                toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya tidak yakin apa yang ada di dalam koktail itu, tapi saya pikir sangat kuat. {/i}"
                scene expression ("gambar/episode1/255.webp") with dissolve
                toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya merasa agak kotor dan terangsang pada saat yang sama. Saya menyentuh pantat perusahaan saya [mom]. {/i}"
                toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
...
Oke ... saya tahu kemana perginya. {/i}"
                        ...
                        toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya tidak percaya seberapa besar dan lunak payudaranya. {/i}"
                        charlotte "{size=12} {color=#FDCA6E} * mengerang sedikit * {/color} {/size}
{i} mhmmm. {/i}"
...
Bagaimana jika setelah menghabiskan begitu banyak waktu di klub, dengan pelacur dan wanita mabuk saya akan mulai memperlakukan gadis -gadis di rumah dengan cara yang sama atau bahkan Emma. {/i}"
    toby "{size=12} {color=#FDCA6E} * Thinking * {/color} {/size} {i}
Saya tidak yakin apa yang harus dipilih. Maksud saya, kedua pekerjaan itu terlihat cukup menjanjikan. Saya akan mengetahuinya besok. {/i}"
    $ progress = 17
    return
