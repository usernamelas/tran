...
screen mod_advanced_settings():
    ...
    text "{size=70}Advanced Mod Settings" color "#FFD700" font "gui/font/Roboto-Bold.ttf" xcenter 0.5 ypos 30
    ...
    viewport:
        ...
        vbox:
            ...
            frame:
                ...
                text "{size=50}{color=#FFD700}GAME VARIABLES EDITOR{/color}" font "gui/font/Roboto-Bold.ttf"
            ...
            frame:
                ...
                text "{size=50}{color=#FFD700}ITEM MANAGEMENT{/color}" font "gui/font/Roboto-Bold.ttf"
            ...
            frame:
                ...
                text "{size=50}{color=#FFD700}EVENT FLAGS MANAGER{/color}" font "gui/font/Roboto-Bold.ttf"
            ...
            frame:
                ...
                text "{size=50}{color=#FFD700}MOD PREFERENCES{/color}" font "gui/font/Roboto-Bold.ttf"
