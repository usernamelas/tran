...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Gallery 1") action ShowMenu("gallery1")
        textbutton _("Gallery 2") action ShowMenu("gallery2")
        textbutton _("Gallery 3") action ShowMenu("gallery3")
        textbutton _("Gallery 4") action ShowMenu("gallery6")
        textbutton _("Gallery 5") action ShowMenu("gallery7")
        textbutton _("Gallery 6") action ShowMenu("gallery8")
        textbutton _("Gallery 7") action ShowMenu("gallery9")
        textbutton _("Gallery 8") action ShowMenu("gallery10")

        # TAMBAHKAN MOD MENU DI SINI:
        textbutton _("{color=#FFD700}Enhanced Mod{/color}") action ShowMenu("my_cheat_mod")
...
screen opport:
    ...
    vbox:
        ...
        text "MORE COMING SOON" size 22 xalign 0.50 yalign 0.4 outlines [(3, "#FF0101", 0, 0)]
        textbutton "RETURN" action Jump("nextday") xalign 0.50 yalign 0.50
...
screen opnotif:
    text "A NEW OPTION IS AVAILABLE" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]

screen opmap:
    text "MAP OPTION IS NOW AVAILABLE" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]

screen opnotif_f:
    text "A NEW OPTION WILL BE AVAILABLE SOON" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]
...
screen s_help():
    ...
    vbox:
        ...
        if rwena == 0:
            text "She shows up after a week of playing, on Wednesday in the hall @15:00" size 18
        elif rwena >= 1:
            text "You've met her" size 18

    vbox:
        text "Create social media page for [sname]" xalign 0.50 yalign 0.20 outlines [(3, "#FFC0CB", 0, 0)]
        xalign 0.50 yalign 0.20
        if rwena == 0:
            text "Rowena will discuss with you about the page" size 18

        elif rwena >= 2 and binstaexp <=5:
            text "Research some tools for page" size 18
            ...
            text "Do some more research" size 18
    ...
    vbox:
        ...
        if workrequest ==3 and rwena >= 1 and rvisit ==0:
            text "You can visit from hall using relax option at 10:00" size 18

        elif workrequest ==3 and rvisit ==1:
            if saction ==0:
                text "Rowena pool unlocked, keep visiting it" size 18
    ...
    vbox:
        ...
        if instadone <1:
            text "Create social media page first" size 18
            ...
            text "Start uploading images to her page" size 18
            ...
            text "Check the page and see what happens" size 18

        elif pagecheckdone >=1 and snameinstaconvinced ==1:
            text "Great!! You've convinced her, visit her room @18:00, Knock, good luck :)" size 18
    ...
    vbox:
        text "Talk about Rowena and kiss" xalign 0.5 yalign 0.50 outlines [(3, "#FFC0CB", 0, 0)]
        ...
        if rvisit >=1 and stalkb_rowena == 0:
            ...
            text "Alternate between watching TV in the morning,and visiting Rowena" size 18

        elif rvisit >=1 and stalkb_rowena == 2:
            text "Repeat alternate between watching TV in the morning,and visiting Rowena" size 18

        elif rvisit >=1 and stalkb_rowena == 3 and rowenaslap ==0:
            text "Visit Rowena pool to get slapped" size 18
            ...
            if saction ==0:
                text "Visit Rowena's pool, Meet her bf (more than one time) Nude beach?" size 18
            elif saction >=1:
            ...
            text "Go ahead and kiss her while watching TV in the morning" size 18
    ...
    vbox:
        ...
        if skiss_asked == 0 and pagecheck <1 and instauploads <1 and bworkstarted ==0:
            ...
            text "Ready to start working, visit map at daytime" size 18
            ...
            text "When to give her the concert tickets?" size 18

        elif mobilephoneacquired == 1 and smobilegiven == 0:
            text "Wisely choose the time to give the phone, you have several options" size 18
...
screen m_help():
    ...
    vbox:
        ...
        if workrequest ==3 and startnework ==0:
            ...
            text "Visit the hall @ 18:00, have the talk with Elaine about renting your room" size 18
        elif workrequest ==1:
            text "Almost there!" size 18
        elif workrequest == 2:
            text "Almost there! Check in the morning" size 18
    ...
    vbox:
        ...
        if workrequest ==3 and wrkquestions >=2 and camerasacquired == 0:
            text "Visit the hall on Sundays @ 18:00 complain then eavesdrop" size 18

        elif workrequest ==3 and wrkquestions >=2 and camerasacquired == 1 and camerafixing == 2 and elaine_convince== 0:
            text "You need to persuade Elaine to convince her to change the job, Sundays @ 18:00" size 18
            ...
            text "Elaine agreed to help you, check on sunday @ 18:00" size 18

        elif workrequest ==3 and elaine_convince == 2:
            text "Elaine agreed to help you, carry on same scenes on sundays" size 18

        elif workrequest ==3 and elaine_convince == 3:
            text "Elaine agreed to help you, carry on same scenes on sundays one more time" size 18

        elif elaine_convince ==4 and startnework ==0:
            text "Good morning, what? New work?" size 18
    ...
    vbox:
        ...
        if mpracticegift == 0 and startnework ==0:
            text "She has to change work" size 18

        elif mpracticegift == 0 and startnework ==1:
            text "Create some drama on Sunday in the daytime" size 18

        elif mpracticegift == 1 and startnework ==1:
            text "You know where to buy it" size 18
...
screen noaccessnotif:
    text "IT'S TOO LATE TO GO IN HERE" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]
...
screen screnotif:
    text "YOU RECEIVED THE SCREWDRIVER" size 35 xalign 0.5 yalign 0.5 outlines [(3, "#000000", 0, 0)]
