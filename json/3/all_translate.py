...
def terjemahkan_teks(teks, dari_bahasa, ke_bahasa):
    try:
        ...
        print(f"{COLOR['merah']}Error menerjemahkan: {e}{COLOR['reset']}")
        return teks
        ...
        if pilihan == '1':
            ...
            for i, (k, v) in enumerate(data.items(), 1):
                if isinstance(v, str):
                    ...
                    print(f"{COLOR['hijau']}[{i}/{total}] {COLOR['reset']}{k}: {hasil[k]}")
        ...
        if pilihan == '1':
            ...
            for i, line in enumerate(lines, 1):
                ...
                if match:
                    ...
                    if tipe == 'new' and teks:
                        terjemahan = terjemahkan_teks(teks, dari_bahasa, ke_bahasa)
                        line = line.replace(f'"{teks}"', f'"{terjemahan}"')
