...
label episode1:
    ...
    toby "{4} {6} * Thinking * {2} {1}
{5} Hidup jauh lebih rapuh daripada yang kita pikirkan. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} seberapa cepat hal -hal dapat berubah selamanya. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} Suatu hari Anda \ 're up dan hari berikutnya Anda turun. {3}"
    scene expression ("images/episode1/002.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1}
{5} Saya tidak bisa percaya bahwa perusahaan saya [6] menjadi bangkrut dan sekarang kita harus pindah. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} Saya sudah terbiasa memiliki semua yang saya inginkan dan sekarang tiba -tiba semuanya hilang. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} Kami baru saja kehilangan rumah kami, yang memiliki kolam renang, sauna, 10 kamar, bioskop dalam ruangan, 8 kamar mandi dan ... sial, sangat sulit untuk mengucapkan selamat tinggal pada semua ini. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} Saya masih berharap ini hanya mimpi yang buruk dan di pagi hari ketika saya bangun, saya masih memiliki mobil sport saya di depan, yang saya dapatkan untuk ulang tahun ke -18 saya. {3}"
    scene expression ("images/episode1/003.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1}
{5} saya [7] memiliki pepatah, \"When you reached the top of the mountain you should take a break and look down for a bit.\"{3}"
    ...
    label memory_01:
        ...
        toby "{4} {6} * Thinking * {2} {1}
{5} berbicara tentang turun. Itu Emma. Dia pacarku. Kami baru saja terhubung beberapa bulan yang lalu. {3}"
        toby "{4} {6} * Thinking * {2} {1}
{5} Saya dulu berada di kelas yang sama dengan dia [3], Cindy. Begitulah cara kami bertemu. {3}"
        toby "{4} {6} * Thinking * {2} {1}
{5} Saya membayar Cindy untuk membantu saya dengan pekerjaan rumah saya. Dengan bantuan, maksud saya dia melakukan semuanya untuk saya. {3}"
        toby "{4} {6} * Thinking * {2} {1}
{5} Saya pikir saya sedikit terlalu manja. {3}"
        scene expression ("images/episode1/005.webp") with dissolve
        show ep1_005
        hide ep1_004
        toby "{4} {6} * Thinking * {2} {1}
{5} mengatakan pria yang tersedot oleh bayi pirang yang cantik. Saya masih manja. {3}"
        toby "{4} {6} * Thinking * {2} {1}
{5} setidaknya sampai dia mengetahui bahwa perusahaan saya [6] menjadi bangkrut dan itulah alasan sebenarnya mengapa kami pergi. {3}"
        ...
        menu:
            "{5} [2] Cium dia {3}"(csq="Emma +1"):
                scene expression ("images/episode1/008.webp") with dissolve
                $ emma_rel += 1
                toby "{4} {6} * Thinking * {2} {1}
{5} 5 hotel bintang pantatku. Saya harus memberitahunya cepat atau lambat bahwa saya bangkrut. {3}"
                scene expression ("images/episode1/007.webp") with dissolve
            "{5} don \ 't menciumnya {3}":
                toby "{4} {6} * Thinking * {2} {1}
{5} 5 hotel bintang pantatku. Saya harus memberitahunya cepat atau lambat bahwa saya bangkrut. {3}"
        ...
        menu:
            "{5} [2] Dirty Talk {3}"(csq="Emma +1 & Gallery Image"):
...
Astaga, ini sangat bagus!"
    ...
    toby "Anda masih memiliki [3] Anda."
    emma "Cindy?"
...
Dan aku akan mengirimmu telanjang sehingga kamu tidak akan melupakanku."
    ...
    toby "{4} {6} * Thinking * {2} {1}
{5} Saya tidur seperti log. Tadi malam itu gila. {3}"
    scene expression ("images/episode1/023.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1}
{5} Dia sangat cantik saat dia tidur. Aku akan merindukan menghabiskan waktu bersamanya. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} menghabiskan waktu? Siapa saya bercanda? Aku akan merindukannya. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} Saya harus mandi. {3}"
    scene expression ("images/episode1/024.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1}
{5} Saya harus memberi tahu Emma alasan sebenarnya mengapa kami pergi. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} Tapi bagaimana jika dia benar -benar menyukai [3] saya mengatakan? {3}"
    scene expression ("images/episode1/025.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1}
{5} Bagaimana jika dia benar -benar bersamaku hanya untuk uang. Maksud saya, saya bukan pria terbaik. {3}"
    toby "{4} {6} * Thinking * {2} {1}
{5} Seksnya bagus, tapi saya merasa harus bisa membicarakan segalanya dengan pacar saya. {3}"
    ...
    toby "{4} {6} * Thinking * {2} {1}
{5} Dia sangat gila dan menyenangkan ketika dia berbicara dengan penisku! {3}"
...
Ini dia. Setelah menghabiskan seluruh hidup saya di satu kota, saya akhirnya pindah ke kota yang berbeda. {3}"
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Saya tidak dapat mengatakan bahwa saya ingin tinggal di sana selamanya, tetapi saya selalu membayangkan diri saya pindah sendiri pada usia ini, tidak seperti ini. {3}"
    scene expression ("images/episode1/035.webp") with dissolve
    play sound "audio/fx/notification_5.mp3"
    "*Notification Sound*"
    scene expression ("images/episode1/034.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1} {5}
Saya sudah 20 sudah. Hidupku tidak menuju ke mana -mana. Saya selalu berencana untuk mendapatkan perusahaan [7] saya suatu hari nanti, tetapi setelah apa yang terjadi, sekarang saya tidak tahu apa yang harus dilakukan dengan hidup saya. {3}"
    scene expression ("images/episode1/035.webp") with dissolve
    play sound "audio/fx/notification_5.mp3"
    "*Notification Sound*"
    scene expression ("images/episode1/034.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1} {5}
Kami bangkrut. Kami kehilangan segalanya dan sekarang kami pindah ke kota tempat mitra [7] saya berada. Seorang temannya akan membiarkan kami tinggal di sana, tetapi siapa yang tahu berapa lama. {3}"
    scene expression ("images/episode1/035.webp") with dissolve
    play sound "audio/fx/notification_5.mp3"
    "*Notification Sound*"
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Itu Patricia, atau Tris seperti yang orang panggil padanya. Dia lebih muda [3]. Selalu bertingkah seolah dia pantas mendapatkan segalanya. Sama seperti sekarang. 
Saya berbicara, dan dia tidak repot -repot menjawab saya. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Kami dulu rukun, tetapi selama beberapa bulan terakhir ini seperti dia menjadi gila. Aku tidak tahu apa yang terjadi padanya, tapi aku tidak bisa melakukan percakapan normal dengannya. {3}"
    scene expression ("images/episode1/036.webp") with dissolve
...
Saya nyaman."
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Itu saya [6]. Pria yang kehilangan segalanya. Dia mengatakan bahwa kita adalah orang dewasa muda, tetapi dia tidak pernah memberi tahu kami bagaimana dia berhasil kehilangan segalanya. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Itu hanya \"Kids, we're bankrupt and we have to move!\". Tidak ada penjelasan, tidak ada apa -apa. Dia tidak menghormati kita dan tidak pernah, tetapi sekarang dia mengharapkan kita untuk berperilaku seperti orang dewasa muda! {3}"
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Dan itu adalah [18] saya. Dia satu -satunya orang normal dalam hal ini [8]. Dia dulunya adalah gadis desa yang sederhana, tapi kemudian dia menikah [6], dan dia agak memberinya semua yang dia inginkan. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Jadi dia mungkin sedikit manja, tetapi meskipun demikian dia mengambil seluruh kebangkrutan dengan cukup baik. Saya kira fakta bahwa dia tidak selalu kaya membuatnya sedikit lebih kuat, tidak seperti [6] dan [9], bahkan mungkin diri saya sendiri. {3}"
    ...
    charlotte "Anda tidak hanya mengatakan itu tentang [5] kami. Saya membesarkannya dengan baik. Anda yang mengacau dan ingin menemukan seseorang untuk disalahkan!"
...
Kami sudah datang. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Akhir -akhir ini [18] dan [6] banyak berdebat. Saya pikir seluruh situasi ini berdampak pada hubungan mereka. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Sekarang saya merasa tidak enak karena menyebabkan situasi ini. Saya seharusnya hanya meninggalkan Tris sendirian. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Aku benci ketika keduanya berdebat. Rasanya seperti selamanya karena kami telah bahagia. Saya tidak percaya bagaimana hancur dapat merusak A [8]. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Saya hanya berharap mereka tidak akan bercerai. Aku membenci itu, tetapi mengetahui [6] dia akan melakukan segala yang dia bisa untuk tidak kehilangan [18] dan mendapatkan kembali perusahaannya. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Dia selalu seperti itu dan dia terus -menerus mencoba membuat saya menjadi seperti dia. Terima kasih, saya juga tidak quitter. {3}"
...
Untung kami senang. {3}"
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Punggung saya sudah sakit sudah hanya memikirkan berapa banyak kotak yang harus kita bawa ke dalam. {3}"
    ...
    toby "Lihat [6]. Saya mengerti Anda kesal karena kehilangan segalanya, tetapi berhenti mengeluarkan masalah Anda pada mereka, terutama pada [18]."
    toby "Jika Anda ingin melepaskan sedikit uap, kami dapat pergi ke gym dan menabrak setiap pukulan yang ada, tetapi [18] dan [9] tidak pantas mendapatkan ini."
...
Itulah yang saya pikirkan. Dia tidak pernah suka mendengarkan siapa pun! {3}"
    ...
    erwin "Anda tetap menjadi favorit saya [4]."
    scene expression ("images/episode1/060.webp") with dissolve
    toby "*batuk*
Hanya [4]!"
    scene expression ("images/episode1/059.webp") with dissolve
    erwin "Terserah, Anda adalah [10] saya, dan Anda pantas mendapatkan yang terbaik. Itulah alasan saya bekerja sangat keras."
    erwin "Untukmu dan untuk istriku yang cantik."
    erwin "Saya minta maaf karena kalian berdua harus berbagi kamar. Setelah kami memiliki lebih banyak uang, saya akan mempekerjakan seseorang untuk memperbaiki loteng untuk [11]!"
    ...
    patricia "Ngomong -ngomong [11], cobalah untuk tidak terlalu nyaman di tempat tidur saya!"
    toby "Ya, ya!"
...
Jika wanita itu menginginkan, wanita itu menginginkannya. Anda tidak dapat berdebat dengan itu. {3}"
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Ini sangat bagus. Senang rasanya melepaskan beberapa stres setelah hari seperti itu. {3}"
...
Sial, Tris bersiap -siap untuk sekolah. Apa yang harus saya lakukan? {3}"
    menu:
        "{5} [2] Ambil mengintip {3}"(csq="Tris +1 & Gallery Image"):
...
Sayang sekali saya punya pacar. {3}"
            ...
            toby "{4} {6} * Thinking * {2} {1} {5}
Sialan [11]. Dia [3] milikmu, bodoh. Anda tidak dapat melihat [3] Anda seperti itu. {3}"
...
Meskipun dia panas sekali. {3}"
        "{5} menjadi baik [15] {3}":
            scene expression ("images/episode1/101.webp") with dissolve
            toby "{4} {6} * Thinking * {2} {1} {5}
Tidak. Tidak hari ini. Hari ini saya bagus [15]. {3}"
    scene expression ("images/episode1/103.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1} {5}
Hari Baru, Kota Baru. Saya merasa harus membantu [6] dengan uang, tetapi saya tidak yakin apa yang bisa saya lakukan untuk mendapatkannya. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Saya selalu bisa pergi berburu pekerjaan, tetapi satu -satunya pekerjaan yang pernah saya miliki adalah di perusahaan [6] saya dan membiarkan jujur, saya agak manja. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Tidak ada yang benar -benar mengharapkan saya untuk melakukan apa pun, jadi itu benar -benar masih seperti saya tidak pernah bekerja sehari pun sepanjang hidup saya. {3}"
...
Bagaimanapun, saya kelaparan. Mari kita lihat apa yang kita miliki di lemari es, jika ada. {3}"
    ...
    toby "Ya. [3] saya sangat buruk. Saya memintanya seperti seribu kali untuk membiarkan saya tidur di tempat tidurnya, tetapi dia tidak akan membiarkan saya."
    scene expression ("images/episode1/108.webp") with dissolve
    charlotte "Oh, sayang. Datang ke [12]. Biarkan dia memberimu ciuman!"
    menu:
        "{5} [2] Biarkan dia menciummu {3}"(csq="Charlotte +1 & Gallery Image"):
            ...
            charlotte "Tentu saja. Lain kali ketika Anda ingin [12] mencium Anda, tanyakan saja!"
            toby "Akan lakukan!"
        "{5} Katakan padanya bahwa Anda berbohong {3}":
            scene expression ("images/episode1/110.webp") with dissolve
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
[1] \ belahan besar sangat besar! {3}"
    menu:
        "{5} [2] Lihat lebih baik {3}"(csq="Charlotte +1 & Gallery Image"):
            $ charlotte_rel += 1
            $ unlockImage(persistent.charlotte_02)
            scene expression ("images/episode1/115.webp") with dissolve
            toby "{4} {6} * Thinking * {2} {1} {5}
Saya tidak bisa percaya seberapa baik dia mencari wanita seusianya. {3}"
        ...
        "{5} saya seharusnya tidak mengambil risiko {3}":
            scene expression ("images/episode1/118.webp") with dissolve
            charlotte "Jadi? Bagaimana menurutmu?"
    ...
    charlotte "Tidak, terima kasih telah menjadi baik [13]."
    charlotte "Sampai jumpa lagi!"
    scene expression ("images/episode1/123.webp") with dissolve
    toby "{4} {6} * Thinking * {2} {1} {5}
[1] benar. Saya harus berbicara dengan Emma tentang apa yang sebenarnya terjadi. Mungkin ketika dia datang untuk mengunjungi saya, saya akan mengatakan yang sebenarnya. {3}"
    scene expression ("images/episode1/124.webp") with long_dissolve
    toby "{4} {6} * Thinking * {2} {1} {5}
Mari kita lihat apa yang terjadi dengan pekerjaan ini? {3}"
    ...
    $ progress = 8
    woman "Pernahkah Anda bekerja sebagai agen real estat sebelumnya?{4} {6} * di telepon * {2} {1}
Selamat pagi. Ya, pekerjaan itu masih tersedia."
    toby "Tidak. Sebenarnya, ini akan menjadi pekerjaan pertama saya."
    woman "{4} {6} * di telepon * {2} {1}
Berapa usiamu?"
...
Mari kita lihat apa yang ada di TV. {3}"
    ...
    katrina "Jadi? Siapa [11]? Ceritakan lebih banyak tentang diri Anda!"
    scene expression ("images/episode1/140.webp") with dissolve
    toby "Nah, saya berumur 20 tahun. Saya baru saja pindah ke kota ini, dan saya pikir saya harus mendapatkan pekerjaan untuk membantu [8] saya."
    scene expression ("images/episode1/139.webp") with dissolve
    ...
    katrina "Menarik ... jadi Anda berasal dari orang kaya [8]."
    scene expression ("images/episode1/143.webp") with dissolve
    katrina "Dan kenapa Anda ingin bekerja di sini jika Anda berasal dari orang kaya [8]?"
...
Wanita ini gila. {3}"
    menu:
        ...
        "[2] Saya dapat memuaskan wanita mana pun, jadi mengapa Anda berbeda?"(csq="Katrina +1 & Gallery Image"):
            $ katrina_rel += 1
...
Pacar perempuan? Bos masa depan saya adalah seorang lesbian? Wow! {3}"
    ...
    darlene "Sayang, bisakah kamu meninggalkan kami? Saya ingin mengenal [11] sedikit lebih baik!"
...
Oke ... itu sangat mencurigakan. {3}"
    ...
    toby "Nah, ini akan menjadi pekerjaan nyata pertama saya. Saya sering membantu di perusahaan [6] saya, tetapi segalanya tidak berjalan dengan baik bagi kami, dan sekarang kami telah pindah ke sini."
    ...
    $ progress = 11
    menu:
        "{5} [2] Go pribadi {3}"(csq="Darlene +1 & Gallery Image"):
            $ darlene_rel += 1
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Wawancara itu benar -benar sesuatu. Itu bukan apa yang saya harapkan, tetapi baik Darlene dan Katrina adalah wanita yang sangat menarik. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Saya ingin tahu siapa yang harus saya hubungi. Di satu sisi yang bekerja sebagai agen real estat akan menjadi pendapatan yang stabil dan pekerjaan yang aman. {3}"
    ...
    toby "{4} {6} * Thinking * {2} {1} {5}
Di sisi lain kehidupan Katrina terdengar menarik. Saya tidak begitu yakin tentang hal obat, tetapi dari apa yang dikatakan Darlene kedengarannya menarik. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
...
Inilah gadis sekolah. {3}"
    ...
    toby "Bagaimanapun, kita harus pergi. [1] sedang menunggu kami pergi ke pantai!"
    ...
    toby "Saya membantu [6] di perusahaannya."
...
Seperti [17], seperti [4]. {3}"
    ...
    patricia "Wow ... mereka memiliki jaring bola voli. Kami benar -benar harus bermain [11]."
    toby "Apakah kita?"
    ...
    charlotte "Jangan bersikap kasar kepada [15] Anda."
    scene expression ("images/episode1/188.webp") with dissolve
    ...
    patricia "Saya tidak setuju dengan [18]. Saya pikir bekerja di klub bisa lebih menarik dan di atas itu, siapa tahu. Mungkin Anda akan bertemu pacar baru."
...
Aku benci gagasan bahwa mungkin Tris benar, tapi itu menyakitkan ketika dia berbicara seperti itu tentang pacarku. {3}"
    ...
    toby "Merasa apa?"
    patricia "Rasa sakit ketika Anda menyadari bahwa [3] Anda selalu benar?"
    toby "Persetan!"
    scene expression ("images/episode1/204.webp") with dissolve
    barman "Itu akan menjadi 0,50."
    $ progress = 14
    menu:
        "{5} [2] Bayar minumannya {3}"(csq="Tris +1 & Gallery Image"):
            $ patricia_rel += 1
            ...
            toby "..."
            toby "{4} {6} * Thinking * {2} {1} {5}
Bung ... dia [3] milikmu. Anda tidak dapat melihat pantatnya. {3}"
            scene expression ("images/episode1/209.webp") with dissolve
            barman "Pak?"
            toby "Maaf?"
        "{5} dia tidak pantas mendapatkannya {3}":
...
Mana yang harus saya berikan [18]? {3}"
    menu:
        "{5} [2] Yang dengan alkohol di dalamnya {3}"(csq="Charlotte +1"):
            $ charlotte_rel += 1
            $ ep1_get_charlotte_drunk = True
        "{5} yang tanpa alkohol di dalamnya {3}":
            pass
    ...
    $ progress = 15
    menu:
        "{5} [2] Biarkan dia menang {3}"(csq="Tris +1 & Gallery Image & Penting untuk Tris \ 'Path"):
            $ patricia_rel += 1
...
Dia memperhatikan. Persetan, persetan dengan hidupku. {3}"
    if patricia_rel == 3:
        ...
        patricia "Ewww. Apa yang salah denganmu? I \ m Anda [3]!"
...
Apa yang [18] lakukan? {3}"
                ...
                charlotte "{4} {6} * Whispering * {2} {1} {5}
Pastikan Anda tidak kehilangan tempat! {3}"
...
Anak baik. {3}"
                toby "{4} {6} * Thinking * {2} {1} {5}
Saya tidak yakin apa yang ada di dalam koktail itu, tapi saya pikir benar -benar kuat. {3}"
                scene expression ("images/episode1/255.webp") with dissolve
                toby "{4} {6} * Thinking * {2} {1} {5}
Saya merasa agak kotor dan terangsang pada saat yang sama. Saya menyentuh pantat perusahaan [18] saya. {3}"
                toby "{4} {6} * Thinking * {2} {1} {5}
Ini bukan yang saya pikir akan terjadi di pantai. {3}"
                menu:
                    "{5} [2] maju {3}"(csq="Charlotte +1 & Gallery Image"):
                        $ charlotte_rel += 1
...
Oke ... saya tahu kemana perginya. {3}"
                        ...
                        toby "{4} {6} * Thinking * {2} {1} {5}
Saya tidak bisa percaya seberapa besar dan lunak payudaranya. {3}"
                        charlotte "{4} {6} * mengosong sedikit * {2} {1}
{5} mhmmm. {3}"
                        scene expression ("images/episode1/260.webp") with dissolve
                        toby "{4} {6} * Thinking * {2} {1} {5}
Saya harus berhenti sebelum Tris berbalik. {3}"
                    "{5} stop {3}" if not _in_replay:
                        pass
...
Tapi kata -kata Katrina terus muncul di kepalaku. Dia berjanji kepada saya banyak uang. Tapi berapa biayanya? {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Maksudku, lihat [6], ketika bisnisnya baik dia berperilaku berbeda dari sekarang. Jadi aman untuk mengatakan bahwa pekerjaan saya akan berdampak pada attiude saya. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Bagaimana jika setelah menghabiskan begitu banyak waktu di klub, dengan pelacur dan wanita mabuk, saya akan mulai memperlakukan gadis -gadis di rumah dengan cara yang sama atau bahkan Emma. {3}"
    toby "{4} {6} * Thinking * {2} {1} {5}
Saya tidak yakin apa yang harus dipilih. Maksud saya, kedua pekerjaan itu terlihat cukup menjanjikan. Saya akan mencari tahu besok. {3}"
    $ progress = 17
    return
